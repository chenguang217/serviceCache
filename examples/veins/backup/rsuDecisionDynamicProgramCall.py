...
def rsuDecision(param: PythonParam):
    ...
    # rsuPos1 = list(rsuList.keys())[0]
    # rsuPos1 = rsuPos1.split(';')[0]
    # print("rsuPos1 is " + str(rsuPos1))
    ...
    # print("tmpLines is " + str(tmpLines))
